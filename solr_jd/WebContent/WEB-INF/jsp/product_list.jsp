...
<div id="filter">
	...
	<div class="fore1">
		...
		<div class="pagin pagin-m">
			...
			<a href="javascript:changePage(-1,${result.pageCount })" class="prev">上一页<b></b></a>
			<a href="javascript:changePage(1,${result.pageCount })" class="next">下一页<b></b></a>
		</div>
		<div class="total">
